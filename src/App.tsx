...
export default function App() {
  ...
  async function analyze() {
    ...
    try {
      ...
      setAiError(e instanceof Error ? `No pude completar el análisis después de varios intentos: ${e.message}` : 'No pude completar el análisis después de varios intentos.');
  ...
  async function analyzeSupplement() {
    ...
    try {
      const prepared = await image.resizeIfNeeded(supplementPhoto, { maxDimension: 700, maxPixels: 490000, quality: 0.58, mimeType: 'image/jpeg' });
